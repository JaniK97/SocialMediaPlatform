...
//Jos query sisältää alaviivan, olettaa, että henkilö hakee käyttäjänimiä
if(strpos($query, '_') !== false) 
	$usersReturnedQuery = mysqli_query($con, "SELECT * FROM users WHERE username LIKE '$query%' AND user_closed='no' LIMIT 8");
//jos on 2 sanaa, olettaa, että ne ovat etu- ja sukunimi
...
//jos queryssä on vain yksi sana, etsii etu tai sukunimiä
else 
