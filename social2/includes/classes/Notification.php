...
class Notification {
    ...
    // hae & palauta lukemattomien ilmoitusten määrä
	...
	public function getNotifications($data, $limit) {
		...
		$num_iterations = 0; //tarkistettujen viestien määrä
		...
		while($row = mysqli_fetch_array($query)) {
			...
			$start_date = new DateTime($row['datetime']); //Postauksen aika
